1. First, clone the repository to your local machine using the following command in your terminal: "git clone https://github.com/MohamedIjlal27/Front-end-Assignment.git"
